...
rel(home,	(x1 + d1 <= x2) || 
	...
	Bounding is then the step which transforms the Branch-and-reduce search into an optimization. To be able to do this an objective function is necessary. In the following I will assume that the objective function has to be minimized with a loss of generality.
