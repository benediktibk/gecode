...
\begin{document}
	...
	As constraint programming is the generalization of linear programming it is at least possible do define linear constraints like \refeq{eq:squares}. Which statements are possible to make and how handy it is to do so varies from the programming language in which the problem is implemented and the used toolset. Typical constraints are
	\begin{itemize}
