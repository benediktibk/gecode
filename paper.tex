...
rel(home,	(x1 + d1 <= x2) || 
	...
	Bounding is then the step which transforms the Branch-and-reduce search into an optimization. To be able to do this an objective function is necessary, which can be inverted. 
