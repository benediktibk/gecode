...
rel(home,	(x1 + d1 <= x2) || 
	...
	\begin{tikzpicture}
		...
		\node[rectangle,draw] at (-3.6, 0) (levelFourElementOne) {$c_2 \lightning$};
	...
	To visualize this effect consider a constraint problem based on two variables $x \in \{1, 5, 6\}$ and $y \in \{1, 2\}$ and two constraints based on them.
	\begin{equation}
		c_1:\ x \le y
	\end{equation}
	\begin{equation}
